...
#pragma region "CODEGEN BIND" // AUTO-GENERATED - DO NOT EDIT MANUALLY
	{
		...
		nb_class
			...
			.def("solve_time_of_flight", nb::overload_cast<const vector3 &, const vector3 &, const vector3 &, const vector3 &, const scalar, const scalar, scalar, scalar, scalar, uint32_t>(&Class::solve_time_of_flight, nb::const_))
	...
	}
	{
		...
		nb_class
			...
			.def("solve_time_of_flight", nb::overload_cast<const vector3 &, const vector3 &, const vector3 &, const vector3 &, const scalar, scalar, scalar, scalar, uint32_t>(&Class::solve_time_of_flight, nb::const_))
