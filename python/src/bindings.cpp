...
#pragma region "CODEGEN BIND" // AUTO-GENERATED - DO NOT EDIT MANUALLY
	{
		...
		nb_class
			...
			.def("optimize_time_of_flight", nb::overload_cast<const vector3 &, const vector3 &, const vector3 &, const vector3 &, const scalar, const scalar, scalar, scalar, const priority, uint32_t>(&Class::optimize_time_of_flight, nb::const_))
			.def("solve_time_of_flight", nb::overload_cast<const vector3 &, const vector3 &, const vector3 &, const vector3 &, const scalar, const scalar, scalar, scalar, scalar, const priority, uint32_t>(&Class::solve_time_of_flight, nb::const_))
	...
	}
	{
		...
		nb_class
			...
			.def("optimize_time_of_flight", nb::overload_cast<const vector3 &, const vector3 &, const vector3 &, const vector3 &, const scalar, scalar, scalar, const priority, uint32_t>(&Class::optimize_time_of_flight, nb::const_))
			.def("solve_time_of_flight", nb::overload_cast<const vector3 &, const vector3 &, const vector3 &, const vector3 &, const scalar, scalar, scalar, scalar, const priority, uint32_t>(&Class::solve_time_of_flight, nb::const_))
