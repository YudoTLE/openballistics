...
#pragma region "CODEGEN BIND" // AUTO-GENERATED - DO NOT EDIT MANUALLY
	{
		...
		nb_class
			...
			.def("compute_trajectory", nb::overload_cast<const vector3 &, const angles &, const vector3 &, const scalar, const scalar, scalar, scalar>(&Class::compute_trajectory, nb::const_))
			.def("optimize_time_of_flight", nb::overload_cast<const vector3 &, const vector3 &, const vector3 &, const vector3 &, const scalar, const scalar, scalar, scalar, uint32_t>(&Class::optimize_time_of_flight, nb::const_))
			.def("optimize_time_of_flight", nb::overload_cast<const vector3 &, const angles &, const vector3 &, const vector3 &, const scalar, const scalar, scalar, scalar, uint32_t>(&Class::optimize_time_of_flight, nb::const_))
			...
			.def("solve_launch_direction_and_time_of_flight", [](const Class &self, const vector3 &launch_position, const vector3 &platform_velocity, const vector3 &target_position, const scalar muzzle_velocity, const scalar twist_of_rifling, const scalar min_time_of_flight, const scalar max_time_of_flight, const scalar miss_distance_threshold, const scalar time_of_flight_segment_size, const uint32_t time_of_flight_max_iterations, const uint32_t launch_direction_max_iterations) { return self.solve_launch_direction_and_time_of_flight(launch_position, platform_velocity, target_position, muzzle_velocity, twist_of_rifling, min_time_of_flight, max_time_of_flight, miss_distance_threshold, time_of_flight_segment_size, time_of_flight_max_iterations, launch_direction_max_iterations); })
			.def("solve_launch_angles_and_time_of_flight", [](const Class &self, const vector3 &launch_position, const vector3 &platform_velocity, const vector3 &target_position, const scalar muzzle_velocity, const scalar twist_of_rifling, const scalar min_time_of_flight, const scalar max_time_of_flight, const scalar miss_distance_threshold, const scalar time_of_flight_segment_size, const uint32_t time_of_flight_max_iterations, const uint32_t launch_direction_max_iterations) { return self.solve_launch_angles_and_time_of_flight(launch_position, platform_velocity, target_position, muzzle_velocity, twist_of_rifling, min_time_of_flight, max_time_of_flight, miss_distance_threshold, time_of_flight_segment_size, time_of_flight_max_iterations, launch_direction_max_iterations); })
	...
	}
	{
		...
		nb_class
			...
			.def("compute_trajectory", nb::overload_cast<const vector3 &, const angles &, const vector3 &, const scalar, scalar, scalar>(&Class::compute_trajectory, nb::const_))
			.def("optimize_time_of_flight", nb::overload_cast<const vector3 &, const vector3 &, const vector3 &, const vector3 &, const scalar, scalar, scalar, uint32_t>(&Class::optimize_time_of_flight, nb::const_))
			.def("optimize_time_of_flight", nb::overload_cast<const vector3 &, const angles &, const vector3 &, const vector3 &, const scalar, scalar, scalar, uint32_t>(&Class::optimize_time_of_flight, nb::const_))
			...
			.def("solve_launch_direction_and_time_of_flight", [](const Class &self, const vector3 &launch_position, const vector3 &platform_velocity, const vector3 &target_position, const scalar muzzle_velocity, const scalar min_time_of_flight, const scalar max_time_of_flight, const scalar miss_distance_threshold, const scalar time_of_flight_segment_size, const uint32_t time_of_flight_max_iterations, const uint32_t launch_direction_max_iterations) { return self.solve_launch_direction_and_time_of_flight(launch_position, platform_velocity, target_position, muzzle_velocity, min_time_of_flight, max_time_of_flight, miss_distance_threshold, time_of_flight_segment_size, time_of_flight_max_iterations, launch_direction_max_iterations); })
