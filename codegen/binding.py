...
def ballistics_bind(
    *,
    ...
    lines = [
        ...
        f'{__}{__}.def("optimize_time_of_flight", nb::overload_cast<const vector3 &, const vector3 &, const vector3 &, const vector3 &, {forward}, scalar, scalar, const priority, uint32_t>(&Class::optimize_time_of_flight, nb::const_))',
        f'{__}{__}.def("solve_time_of_flight", nb::overload_cast<const vector3 &, const vector3 &, const vector3 &, const vector3 &, {forward}, scalar, scalar, scalar, const priority, uint32_t>(&Class::solve_time_of_flight, nb::const_))',
